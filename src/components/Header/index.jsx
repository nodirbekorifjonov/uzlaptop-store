...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="header-first border-b-[1px] border-[#E0E0E0] py-[2rem] max-[876px]:py-[1.5rem] max-[876px]:border-transparent">
          <div className="site-container flex justify-between items-center">
            ...
            {/* Mobile Nav */}
            <nav
              className={`mobile-nav flex flex-col translate-x-[-100%] invisible py-[2rem] transition-all duration-300 absolute bg-[#fff] left-0 top-[13rem] bottom-0 w-[80%] h-screen ${addActive}`}
            >
      ...
      <div
        onClick={handleAddActive}
        className={`overlay absolute top-0 left-0 bottom-0 bg-black invisible opacity-50 w-full h-screen block z-[1] transition-all duration-300 ${addActive}`}
      ></div>
    </>
  );
};
